export default function Home() {
  return (
    <div className="flex">
      <aside className="bg-white w-[300px] overflow-y-auto h-screen sticky top-0 px-4 py-8">
        ...
        <div className="flex justify-between">
          <div className="flex space-x-3 items-center">
            <img className="w-10 h-10" src="/sidebar/avatar.png" alt="Vercel" />
      ...
      <main className="bg-[#F5F5F5] w-full p-8">
        <div>
          <div>
              ...
              <div class="overflow-x-auto shadow-md sm:rounded-lg">
                <div class="inline-block min-w-full align-middle">
                  <div class="overflow-hidden">
                    <table class="table-box-shadow min-w-full divide-y divide-gray-200 table-fixed">
                      <thead class="bg-gray-100 ">
                        <tr className="text-xs text-[#667085] leading-[18px]">
                          ...
                          <th
                            scope="col"
                            class="py-3 px-6 text-xs font-medium tracking-wider text-left text-gray-700 capitalize dark:text-gray-400"
                          >
                            Invoice
                          </th>
                          <th
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr class="hover:bg-gray-100 leading-[20px]">
                          <td class="p-4 w-4">
                            <div class="flex items-center">
                              <input
                                id="checkbox-table-1"
                          ...
                          <td class="py-6 px-6 text-sm font-medium text-[#101828] whitespace-nowrap">
                            Basic Plan Dec 2022
                          </td>
                          <td class="py-6 px-6 text-xs text-[#667085] font-mediu whitespace-nowrap">
                            USD $10.00
                          </td>
                          <td class="py-6 px-6  text-xs text-[#667085] font-medium whitespace-nowrap">
                            Dec 1, 2022
                          </td>
                          <td class="py-6 px-6 text-xs text-[#667085] font-medium  whitespace-nowrap">
                            <div className="bg-[#ECFDF3] flex items-center w-fit px-2 py-1 rounded-full">
                              <img src="/sidebar/check-mark.svg" alt="Vercel" />
                              <span className="ml-[6px] text-[#027A48]">
                                Paid
                              </span>
                            </div>
                          </td>
                          <td class="py-6 px-6  text-xs text-[#667085] font-medium  whitespace-nowrap">
                            <img src="/sidebar/avatar-group.png" alt="Vercel" />
                          </td>
                          <td class="py-6 px-6  text-xs text-[#667085] font-medium  whitespace-nowrap">
                            <img
